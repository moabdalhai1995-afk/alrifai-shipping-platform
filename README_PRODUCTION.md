...
الوضع الافتراضي الحالي هو **مساعد محلي مجاني** لا يحتاج إلى بطاقة أو رصيد أو مفتاح OpenAI. يحلل بيانات المنصة داخل الخادم ويقترح الأولويات والمهام دون إرسال البيانات إلى خدمة خارجية.
