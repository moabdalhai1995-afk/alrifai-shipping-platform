...
# مساعد المدير بالذكاء الاصطناعي

أضف في Render:

- `OPENAI_API_KEY`: مفتاح OpenAI API، ويُحفظ على الخادم فقط.
- `OPENAI_MODEL`: اسم النموذج المستخدم. القيمة الافتراضية `gpt-5.6-luna` ويمكن تغييرها دون تعديل الكود.

المساعد يقرأ ملخصًا محدودًا من الطلبات والمخزون والدعم ورسائل واتساب، ولا تُرسل له كلمات المرور أو المفاتيح. اقتراحاته لا تُنفذ تلقائيًا؛ يجب أن يؤكد المدير كل إجراء من لوحة الإدارة.
