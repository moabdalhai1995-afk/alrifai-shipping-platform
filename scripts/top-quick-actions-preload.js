...
function injectTopQuickActions(html, reqPath = "") {
  ...
  if (html.includes('id="top-quick-actions-v1"')) return html;
...
#top-quick-actions-v1{position:fixed;top:max(8px,env(safe-area-inset-top));left:10px;z-index:10050;display:flex;align-items:center;gap:7px;direction:rtl;font-family:Tahoma,Arial,sans-serif}
