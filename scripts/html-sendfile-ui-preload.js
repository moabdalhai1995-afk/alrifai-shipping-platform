...
function applyBarrelDoorToDoorPrice(source) {
  ...
  if (html.includes("خدمة الشحن فقط")) {
    html = html
      ...
      .replace("<div class=\"service-note\"><b>الخدمة تشمل:</b>", "<div class=\"service-note\"><b>جميع الشحنات تشمل خدمة التغليف والتجهيز.</b><br><b>يصدر باركود تعريف مستقل لكل قطعة ويرتبط برقم التتبع الرئيسي لصاحب الشحنة.</b><br><span>الأسعار: البرميل 350 ريال · الشنطة الكبيرة 250 ريال · الكرتون حتى 30 كجم 200 ريال.</span><br><span>الخدمة تشمل:</span>")
      ...
      .replace("${customerNotes?`\\n${customerNotes}`:''}`;", "\\nخدمة التغليف: مشمولة لجميع الشحنات\\nتعريف الباركود: باركود مستقل لكل قطعة مرتبط برقم التتبع الرئيسي${customerNotes?`\\n${customerNotes}`:''}`;")
      .replace("<p>سنتواصل معك لتنسيق استلام الشحنة في السعودية.</p>", "<p>✅ تشمل الخدمة تغليف الشحنة وتجهيزها.</p><p>🏷️ سيصدر باركود مستقل لكل قطعة مرتبط برقم التتبع الرئيسي.</p><p>سنتواصل معك لتنسيق استلام الشحنة في السعودية.</p>");
  }
