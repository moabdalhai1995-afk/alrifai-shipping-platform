...
function applyBarrelDoorToDoorPrice(source) {
  ...
  if (html.includes("خدمة الشحن فقط")) {
    html = html
      ...
      .replace("<div class=\"service-note\"><b>الخدمة تشمل:</b>", "<div class=\"service-note\"><b>الأسعار: البرميل 350 ريال · الشنطة الكبيرة 250 ريال · الكرتون حتى 30 كجم 200 ريال.</b><br><span>الخدمة تشمل:</span>")
